...
func (b *SinovateRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (b *SinovateRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return b.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (b *SinovateRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
